...
class EventRepositoryTest {
    ...
    void findAllByStatusOrderByStartAtAsc() {
        // given
        Event activeEvent1 = new Event(null, "Active Event 1", LocalDateTime.now().plusDays(1), "CONCERT", "Venue A", 10000, null, null, EventStatus.ACTIVE, "#FFFFFF", "😀", null);
        Event activeEvent2 = new Event(null, "Active Event 2", LocalDateTime.now().plusDays(2), "CONCERT", "Venue B", 10000, null, null, EventStatus.ACTIVE, "#FFFFFF", "😀", null);
        Event inactiveEvent = new Event(null, "Inactive Event", LocalDateTime.now().plusDays(3), "CONCERT", "Venue C", 10000, null, null, EventStatus.INACTIVE, "#FFFFFF", "😀", null);
